        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview" id="mainNav">
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="mainNav"><a href="{{route('user.usermanage')}}"><i class="fa fa-circle-o"></i>
                            Manage Users</a></li>
                </ul>
            </li>
            ...
            <li class="treeview" id="mainNav">
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="mainNav"><a href="{{route('customer.manage')}}"><i class="fa fa-circle-o"></i> Manage
                            Customers</a></li>
                </ul>
            </li>
            ...
            <li class="treeview" id="mainNav">
                ...
                <ul class="treeview-menu">
                    <li id="mainNav"><a href="{{route('suppler')}}"><i class="fa fa-circle-o"></i>
                            Add Suppliers </a></li>

                    <li id="mainNav"><a href="{{route('supplier.manage')}}"><i class="fa fa-circle-o"></i> Manage
                            Suppliers</a></li>
                </ul>
            </li>
            ...
            <li class="treeview" id="">
                ...
                <ul class="treeview-menu">
                    <li id="addPurchaseNav"><a href="{{route('purchase')}}"><i class="fa fa-circle-o"></i> Add
                            Purchase</a></li>
                    <li id="managePurchaseNav"><a href="{{route('manage.purchase')}}"><i class="fa fa-circle-o"></i>
                            Manage Purchase</a></li>
                </ul>
            </li>
